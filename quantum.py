    ...
    while (player):
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if textRect.collidepoint(mouse_x, mouse_y):
                    print("I am here")
...
def connected_qubits_with_entanglement(history_of_moves, entanglement_coordinates):
    ...
    for i, coordinate in enumerate(history_of_moves):
        if coordinate in entanglement_coordinates:
            print("This is coordinate", coordinate)
            index_1 = i // 2
            index_2 = i % 2
            print(f" this is index 1 and 2{index_1}, {index_2}")
