...
def display_winner(winner):
    ...
    # Center the text in the existing rectangle
    textRect = text.get_rect()
    ...
    # Create and return buttons for interaction
    restart_button, end_button = finish_game()  # Ensure finish_game() properly defines these
...
def collapse(
    ...
    if entanglement_:
        ...
        # Modify this part to handle different lengths of connected
        for connection in connected:
            # Skip connections that don't have exactly 3 elements
            if len(connection) != 3:
                continue
